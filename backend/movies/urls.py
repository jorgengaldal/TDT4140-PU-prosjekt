...
urlpatterns = [
    ...
    path('awards/<str:name>/', views.AwardDetailView.as_view(), name='awards_detail'),
    path('countries/', views.CountryListView.as_view(), name='country_list'),
    path('countries/<str:name>/', views.CountryDetailView.as_view(), name='country_detail'),
    path('languages/', views.LanguageListView.as_view(), name='language_list'),
    path('languages/<str:name>/', views.LanguageDetailView.as_view(), name='language_detail'),
    path('genres/', views.GenreListView.as_view(), name='genre_list'),
    path('genres/<str:name>/', views.GenreDetailView.as_view(), name='genre_detail'),
